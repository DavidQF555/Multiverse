...
public final class NoiseSettingsRegistry {
    ...
    static {
        ...
        builder.put(TOP, createDefaultSettings(false, true, NoiseSettings.create(0, 128, new NoiseSamplingSettings(1, 1, 80, 30), new NoiseSlider(120, 3, 0), new NoiseSlider(-30, 7, 1), 1, 2, TerrainProvider.nether()), 0, NoiseRouterData::nether));
        builder.put(BOTTOM, createDefaultSettings(true, false, NoiseSettings.create(0, 256, new NoiseSamplingSettings(1, 2, 80, 160), new NoiseSlider(-10, 3, 0), new NoiseSlider(-30, 0, 0), 1, 2, TerrainProvider.overworld(false)), 63, noise -> NoiseRouterData.overworldWithNewCaves(noise, false)));
        builder.put(NONE, createDefaultSettings(false, false, NoiseSettings.create(0, 128, new NoiseSamplingSettings(2, 1, 80, 160), new NoiseSlider(-3000, 64, -46), new NoiseSlider(-30, 7, 1), 2, 1, TerrainProvider.end()), 0, NoiseRouterData::end));
        builder.put(BOTH, createDefaultSettings(true, true, NoiseSettings.create(0, 128, new NoiseSamplingSettings(1, 3, 80, 60), new NoiseSlider(120, 3, 0), new NoiseSlider(320, 4, -1), 1, 2, TerrainProvider.nether()), 32, NoiseRouterData::nether));
        ALL = builder.build();
    }
    ...
    private static NoiseGeneratorSettings createDefaultSettings(boolean floor, boolean ceiling, NoiseSettings noise, int sea, Function<NoiseSettings, NoiseRouterWithOnlyNoises> router) {
