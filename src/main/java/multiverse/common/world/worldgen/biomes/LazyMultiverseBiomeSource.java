...
public class LazyMultiverseBiomeSource extends LazyBiomeSource {
    ...
    public LazyMultiverseBiomeSource(HolderLookup.RegistryLookup<Biome> registry, HolderLookup.RegistryLookup<DimensionType> dimType, int minY, int maxY, long seed, double temperature, double humidity, MultiverseType type, HolderSet<Biome> biomes) {
        super(() -> MultiNoiseBiomeSource.createFromList(parameters(registry, dimType, minY, maxY, seed, temperature, humidity, type, biomes)));
    ...
    public static Climate.ParameterList<Holder<Biome>> parameters(HolderLookup.RegistryLookup<Biome> registry, HolderLookup.RegistryLookup<DimensionType> dimType, int minY, int maxY, long seed, double temperature, double humidity, MultiverseType type, HolderSet<Biome> biomes) {
