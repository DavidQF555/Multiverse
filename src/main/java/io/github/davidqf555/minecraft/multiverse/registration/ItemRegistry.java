...
public final class ItemRegistry {
    ...
    public static final DeferredItem<ArmorItem> KALEIDITE_HELMET = register("kaleidite_helmet", List.of(CreativeModeTabRegistry.MULTIVERSE.getKey(), CreativeModeTabs.COMBAT), prop -> new ArmorItem(KALEIDITE_ARMOR, ArmorType.HELMET, prop), new Item.Properties().durability(ArmorType.HELMET.getDurability(33)));
    public static final DeferredItem<ArmorItem> KALEIDITE_CHESTPLATE = register("kaleidite_chestplate", List.of(CreativeModeTabRegistry.MULTIVERSE.getKey(), CreativeModeTabs.COMBAT), prop -> new ArmorItem(KALEIDITE_ARMOR, ArmorType.CHESTPLATE, prop), new Item.Properties().durability(ArmorType.CHESTPLATE.getDurability(33)));
    public static final DeferredItem<ArmorItem> KALEIDITE_LEGGINGS = register("kaleidite_leggings", List.of(CreativeModeTabRegistry.MULTIVERSE.getKey(), CreativeModeTabs.COMBAT), prop -> new ArmorItem(KALEIDITE_ARMOR, ArmorType.LEGGINGS, prop), new Item.Properties().durability(ArmorType.LEGGINGS.getDurability(33)));
    public static final DeferredItem<ArmorItem> KALEIDITE_BOOTS = register("kaleidite_boots", List.of(CreativeModeTabRegistry.MULTIVERSE.getKey(), CreativeModeTabs.COMBAT), prop -> new ArmorItem(KALEIDITE_ARMOR, ArmorType.BOOTS, prop), new Item.Properties().durability(ArmorType.BOOTS.getDurability(33)));
    public static final DeferredItem<SummonCrossbowItem> BEACON_CROSSBOW = register("beacon_crossbow", List.of(CreativeModeTabRegistry.MULTIVERSE.getKey(), CreativeModeTabs.COMBAT), SummonCrossbowItem::new, () -> new Item.Properties().repairable(MultiverseTags.KALEIDITE_MATERIALS).stacksTo(1).durability(465).rarity(Rarity.EPIC));
    ...
    public static final DeferredItem<BeaconArmorItem> BEACON_CHESTPLATE = register("beacon_chestplate", List.of(CreativeModeTabRegistry.MULTIVERSE.getKey(), CreativeModeTabs.COMBAT), prop -> new BeaconArmorItem(BEACON_ARMOR, ArmorType.CHESTPLATE, prop), new Item.Properties().durability(ArmorType.CHESTPLATE.getDurability(33)).rarity(Rarity.EPIC));
    public static final DeferredItem<WarpShieldItem> WARP_SHIELD = register("warp_shield", List.of(CreativeModeTabRegistry.MULTIVERSE.getKey(), CreativeModeTabs.COMBAT), WarpShieldItem::new, () -> new Item.Properties().durability(336).repairable(MultiverseTags.KALEIDITE_MATERIALS).rarity(Rarity.EPIC));
