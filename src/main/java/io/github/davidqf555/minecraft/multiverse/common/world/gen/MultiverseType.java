...
public enum MultiverseType {
    ...
    OVERWORLD_ISLANDS(NoiseSettingsRegistry.OVERWORLD_ISLANDS, false, false, 128, Blocks.STONE.defaultBlockState(), Blocks.WATER.defaultBlockState(), new NoiseSamplingSettings(2, 1, 80, 160), new NoiseSlider(-23.4375, 64, -46), new NoiseSlider(-0.234375, 7, 1), 2, 1, TerrainProvider.floatingIslands(), 0, SurfaceRuleData.overworldLike(true, false, true), type -> !type.equals(BiomeDictionary.Type.NETHER) && !type.equals(BiomeDictionary.Type.END), biome -> BiomeDictionary.hasType(biome, BiomeDictionary.Type.OVERWORLD), Biomes.PLAINS),
    ...
    NETHER_ISLANDS(NoiseSettingsRegistry.NETHER_ISLANDS, false, false, 128, Blocks.NETHERRACK.defaultBlockState(), Blocks.LAVA.defaultBlockState(), new NoiseSamplingSettings(2, 1, 80, 160), new NoiseSlider(-23.4375, 64, -46), new NoiseSlider(-0.234375, 7, 1), 2, 1, TerrainProvider.floatingIslands(), 0, MultiverseSurfaceRuleData.nether(false, false), type -> !type.equals(BiomeDictionary.Type.OVERWORLD) && !type.equals(BiomeDictionary.Type.END), biome -> BiomeDictionary.hasType(biome, BiomeDictionary.Type.NETHER), Biomes.NETHER_WASTES),
    ...
    END_ISLANDS(NoiseSettingsRegistry.END_ISLANDS, false, false, 128, Blocks.END_STONE.defaultBlockState(), Blocks.AIR.defaultBlockState(), new NoiseSamplingSettings(2, 1, 80, 160), new NoiseSlider(-23.4375, 64, -46), new NoiseSlider(-0.234375, 7, 1), 2, 1, TerrainProvider.floatingIslands(), 0, MultiverseSurfaceRuleData.end(false, true), type -> !type.equals(BiomeDictionary.Type.OVERWORLD) && !type.equals(BiomeDictionary.Type.NETHER), biome -> BiomeDictionary.hasType(biome, BiomeDictionary.Type.END), Biomes.THE_END);
    ...
    MultiverseType(ResourceKey<NoiseGeneratorSettings> key, boolean ceiling, boolean floor, int height, BlockState defBlock, BlockState defFluid, NoiseSamplingSettings sampling, NoiseSlider top, NoiseSlider bottom, int sizeHorizontal, int sizeVertical, TerrainShaper terrain, int sea, SurfaceRules.RuleSource surface, Predicate<BiomeDictionary.Type> biomeType, Predicate<ResourceKey<Biome>> biome, ResourceKey<Biome> base) {
        this.key = key;
        this.floor = floor;
