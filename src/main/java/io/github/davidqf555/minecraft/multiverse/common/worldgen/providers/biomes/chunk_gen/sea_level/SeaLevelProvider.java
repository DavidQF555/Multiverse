...
public interface SeaLevelProvider {
    ...
    Codec<SeaLevelProvider> DIRECT_CODEC = Codec.lazyInitialized(() -> SeaLevelProviderTypeRegistry.getRegistry().byNameCodec().dispatch(SeaLevelProvider::getCodec, Function.identity()));
    ...
    MapCodec<? extends SeaLevelProvider> getCodec();
