...
public final class EventBusSubscriber {
    ...
    public static void onRegisterShaders(RegisterShadersEvent event) throws IOException {
        ...
        event.registerShader(new ShaderInstance(event.getResourceProvider(), new ResourceLocation(Multiverse.MOD_ID, "rift_particle"), DefaultVertexFormat.PARTICLE), shader -> ClientHelper.riftParticleShader = shader);
    }
