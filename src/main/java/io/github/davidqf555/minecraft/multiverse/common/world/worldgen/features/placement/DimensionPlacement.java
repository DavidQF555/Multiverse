...
public class DimensionPlacement extends PlacementModifier {
    ...
    public static final MapCodec<DimensionPlacement> CODEC = ResourceKey.codec(Registries.DIMENSION).listOf().xmap(list -> new DimensionPlacement(Set.copyOf(list)), placement -> List.copyOf(placement.worlds)).fieldOf("dimensions");
