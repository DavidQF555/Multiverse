...
public final class EntityRegistry {
    ...
    public static final RegistryObject<EntityType<ConquerorEntity>> CONQUEROR = register("conqueror", EntityType.Builder.of(ConquerorEntity::new, MobCategory.MONSTER).sized(0.6f, 1.95f));
