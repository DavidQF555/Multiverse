...
public final class ItemRegistry {
    ...
    public static final RegistryObject<ArmorItem> KALEIDITE_CHESTPLATE = register("kaleidite_chestplate", () -> List.of(ItemRegistry.getTab(), CreativeModeTabs.COMBAT), () -> new ArmorItem(KaleiditeArmorMaterial.KALEIDITE, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
