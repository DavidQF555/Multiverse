...
public class RiftTileEntityRenderer implements BlockEntityRenderer<RiftTileEntity> {
    ...
    private static final ResourceLocation BACKGROUND = ResourceLocation.fromNamespaceAndPath(Multiverse.MOD_ID, "textures/block/rift_background.png");
    ...
    private void renderFace(Matrix4f p_173696_, VertexConsumer p_173697_, float p_173698_, float p_173699_, float p_173700_, float p_173701_, float p_173702_, float p_173703_, float p_173704_, float p_173705_, int color) {
        p_173697_.addVertex(p_173696_, p_173698_, p_173700_, p_173702_).setColor(color);
        p_173697_.addVertex(p_173696_, p_173699_, p_173700_, p_173703_).setColor(color);
        p_173697_.addVertex(p_173696_, p_173699_, p_173701_, p_173704_).setColor(color);
        p_173697_.addVertex(p_173696_, p_173698_, p_173701_, p_173705_).setColor(color);
    }
