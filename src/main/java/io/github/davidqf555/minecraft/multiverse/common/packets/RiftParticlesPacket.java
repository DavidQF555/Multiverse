...
public class RiftParticlesPacket {
    ...
    private static final Function<FriendlyByteBuf, RiftParticlesPacket> DECODER = buffer -> new RiftParticlesPacket(new Vec3(buffer.readDouble(), buffer.readDouble(), buffer.readDouble()), buffer.readBoolean() ? buffer.readResourceKey(Registries.DIMENSION) : null);
