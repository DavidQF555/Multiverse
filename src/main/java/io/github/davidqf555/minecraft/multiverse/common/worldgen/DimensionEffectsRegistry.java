...
public final class DimensionEffectsRegistry {
    ...
    public static void onFMLCommonSetup(FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            MultiverseEffectType.register(new MultiverseEffectType(32, false, DimensionType.OVERWORLD_EFFECTS));
            MultiverseEffectType.register(new MultiverseEffectType(8, true, DimensionType.END_EFFECTS));
