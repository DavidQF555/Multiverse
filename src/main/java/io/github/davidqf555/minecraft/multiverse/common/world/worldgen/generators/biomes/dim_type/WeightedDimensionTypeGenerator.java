...
public class WeightedDimensionTypeGenerator implements BiomeDimensionTypeGenerator {
    ...
    public static final MapCodec<WeightedDimensionTypeGenerator> CODEC = Entry.CODEC.listOf().xmap(WeightedDimensionTypeGenerator::new, val -> val.entries).fieldOf("entries");
    ...
    @Override
    public MapCodec<? extends WeightedDimensionTypeGenerator> getCodec() {
