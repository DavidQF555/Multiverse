...
import multiverse.common.world.worldgen.generators.biomes.chunk_gen.biome_source.BiomeSourceGeneratorType;
...
public final class BiomeSourceGeneratorTypeRegistry {
    ...
    public static final ResourceKey<Registry<BiomeSourceGeneratorType<?>>> LOCATION = ResourceKey.createRegistryKey(new ResourceLocation(Multiverse.MOD_ID, "generator/biome_sources"));
