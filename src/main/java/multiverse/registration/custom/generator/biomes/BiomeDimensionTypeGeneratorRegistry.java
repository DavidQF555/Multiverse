...
public final class BiomeDimensionTypeGeneratorRegistry {
    ...
    public static void onNewRegistry(NewRegistryEvent event) {
        registry = event.create(new RegistryBuilder<BiomeDimensionTypeGenerator>().setType(BiomeDimensionTypeGenerator.class).setName(LOCATION.location()).dataPackRegistry(BiomeDimensionTypeGenerator.DIRECT_CODEC));
    }
