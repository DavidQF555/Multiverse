...
public class NoiseChunkGeneratorGenerator implements BiomeChunkGeneratorGenerator<MultiverseNoiseChunkGenerator> {
    ...
    public static final MapCodec<NoiseChunkGeneratorGenerator> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
    ...
    @Override
    public MapCodec<? extends NoiseChunkGeneratorGenerator> getCodec() {
