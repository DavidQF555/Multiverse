...
public final class BiomeNoiseGeneratorSettingsProviderTypeRegistry {
    ...
    public static final ResourceKey<Registry<BiomeNoiseGeneratorSettingsGeneratorType<?>>> LOCATION = ResourceKey.createRegistryKey(new ResourceLocation(Multiverse.MOD_ID, "noise_generator_settings_type"));
