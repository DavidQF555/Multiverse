...
public class TypeMapNoiseGeneratorSettingsProvider implements BiomeNoiseGeneratorSettingsProvider {
    ...
    public static final MapCodec<TypeMapNoiseGeneratorSettingsProvider> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
    ...
    @Override
    public MapCodec<? extends TypeMapNoiseGeneratorSettingsProvider> getCodec() {
