...
public class TypeMapDimensionTypeGenerator implements BiomeDimensionTypeProvider {

    public static final Codec<TypeMapDimensionTypeGenerator> CODEC = Codec.simpleMap(MultiverseType.CODEC, BiomeDimensionTypeProvider.CODEC, Keyable.forStrings(() -> Arrays.stream(MultiverseType.values()).map(MultiverseType::getName)))
    ...
    public TypeMapDimensionTypeGenerator(Map<MultiverseType, Holder<BiomeDimensionTypeProvider>> values) {
        this.values = values;
    }
