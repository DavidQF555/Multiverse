...
public class EffectsManager {
    ...
    public static final Codec<Pair<ResourceLocation, Integer>> ENTRY_CODEC = Codec.mapPair(
            ResourceLocation.CODEC.fieldOf("effect"),
            ExtraCodecs.NON_NEGATIVE_INT.optionalFieldOf("weight", 1)
    ).codec();
    private static final Gson GSON = new GsonBuilder().create();
    private static final Logger LOGGER = LogUtils.getLogger();
    private final Map<ResourceLocation, Integer> effects = new HashMap<>();
    ...
    public Map<ResourceLocation, Integer> getEffects() {
        return effects;
    }
