...
public final class GeneratorEvents {
    ...
    public static void onServerAboutToStart(ServerAboutToStartEvent event) throws IOException {
        if (ModList.get().isLoaded(TERRABLENDER)) {
            MultiverseConfig.setBiomesManager(new TerraBlenderBiomes(event.getServer().registryAccess().lookupOrThrow(Registries.BIOME)));
        }
        ...
        MappedRegistry<LevelStem> registry = (MappedRegistry<LevelStem>) access.lookupOrThrow(Registries.LEVEL_STEM);
