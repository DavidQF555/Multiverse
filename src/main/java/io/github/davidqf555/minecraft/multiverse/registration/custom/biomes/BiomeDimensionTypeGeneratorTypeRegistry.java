...
public final class BiomeDimensionTypeGeneratorTypeRegistry {
    ...
    public static final ResourceKey<Registry<BiomeDimensionTypeGeneratorType>> LOCATION = ResourceKey.createRegistryKey(new ResourceLocation(Multiverse.MOD_ID, "dimension_type_generator_type"));
