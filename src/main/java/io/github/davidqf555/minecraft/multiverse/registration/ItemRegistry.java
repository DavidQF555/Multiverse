...
public final class ItemRegistry {
    ...
    public static final DeferredHolder<Item, SwordItem> KALEIDITE_SWORD = register("kaleidite_sword", List.of(CreativeModeTabRegistry.MULTIVERSE.getKey(), CreativeModeTabs.COMBAT), () -> new SwordItem(KALEIDITE_TIER, new Item.Properties()));
    public static final DeferredHolder<Item, PickaxeItem> KALEIDITE_PICKAXE = register("kaleidite_pickaxe", List.of(CreativeModeTabRegistry.MULTIVERSE.getKey(), CreativeModeTabs.TOOLS_AND_UTILITIES), () -> new PickaxeItem(KALEIDITE_TIER, new Item.Properties()));
    public static final DeferredHolder<Item, ShovelItem> KALEIDITE_SHOVEL = register("kaleidite_shovel", List.of(CreativeModeTabRegistry.MULTIVERSE.getKey(), CreativeModeTabs.TOOLS_AND_UTILITIES), () -> new ShovelItem(KALEIDITE_TIER, new Item.Properties()));
    public static final DeferredHolder<Item, AxeItem> KALEIDITE_AXE = register("kaleidite_axe", List.of(CreativeModeTabRegistry.MULTIVERSE.getKey(), CreativeModeTabs.TOOLS_AND_UTILITIES), () -> new AxeItem(KALEIDITE_TIER, new Item.Properties()));
    public static final DeferredHolder<Item, RiftSwordItem> PRISMATIC_SWORD = register("prismatic_sword", List.of(CreativeModeTabRegistry.MULTIVERSE.getKey(), CreativeModeTabs.COMBAT), () -> new RiftSwordItem(KALEIDITE_TIER, new Item.Properties().rarity(Rarity.EPIC)));
    public static final DeferredHolder<Item, MultiversalPickaxeItem> PRISMATIC_PICKAXE = register("prismatic_pickaxe", List.of(CreativeModeTabRegistry.MULTIVERSE.getKey(), CreativeModeTabs.TOOLS_AND_UTILITIES), () -> new MultiversalPickaxeItem(KALEIDITE_TIER, new Item.Properties().rarity(Rarity.EPIC)));
    public static final DeferredHolder<Item, MultiversalShovelItem> PRISMATIC_SHOVEL = register("prismatic_shovel", List.of(CreativeModeTabRegistry.MULTIVERSE.getKey(), CreativeModeTabs.TOOLS_AND_UTILITIES), () -> new MultiversalShovelItem(KALEIDITE_TIER, new Item.Properties().rarity(Rarity.EPIC)));
    public static final DeferredHolder<Item, MultiversalAxeItem> PRISMATIC_AXE = register("prismatic_axe", List.of(CreativeModeTabRegistry.MULTIVERSE.getKey(), CreativeModeTabs.TOOLS_AND_UTILITIES), () -> new MultiversalAxeItem(KALEIDITE_TIER, new Item.Properties().rarity(Rarity.EPIC)));
