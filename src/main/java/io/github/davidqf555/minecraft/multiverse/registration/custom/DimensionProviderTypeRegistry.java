...
import io.github.davidqf555.minecraft.multiverse.common.world.worldgen.generators.DimensionGeneratorType;
...
public final class DimensionProviderTypeRegistry {
    ...
    public static final ResourceKey<Registry<DimensionGeneratorType<?>>> LOCATION = ResourceKey.createRegistryKey(new ResourceLocation(Multiverse.MOD_ID, "dimension_provider"));
