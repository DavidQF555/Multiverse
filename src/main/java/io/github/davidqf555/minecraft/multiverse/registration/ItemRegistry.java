...
public final class ItemRegistry {
    ...
    public static final DeferredItem<WarpShieldItem> WARP_SHIELD = register("warp_shield", List.of(CreativeModeTabRegistry.MULTIVERSE.getKey(), CreativeModeTabs.COMBAT), prop -> new WarpShieldItem(ChatFormatting.GOLD, prop), () -> new Item.Properties().durability(336).repairable(MultiverseTags.KALEIDITE_MATERIALS).equippableUnswappable(EquipmentSlot.OFFHAND).rarity(Rarity.EPIC));
    ...
    public static final DeferredItem<SpawnEggItem> TRAVELER_SPAWN_EGG = register("traveler_spawn_egg", List.of(CreativeModeTabs.SPAWN_EGGS), prop -> new SpawnEggItem(EntityRegistry.TRAVELER.get(), 0x5BE6FF, 0x4A6CF7, prop), new Item.Properties());
    public static final DeferredItem<SpawnEggItem> CONQUEROR_SPAWN_EGG = register("conqueror_spawn_egg", List.of(CreativeModeTabs.SPAWN_EGGS), prop -> new SpawnEggItem(EntityRegistry.CONQUEROR.get(), 0x5BE6FF, 0xE0B230, prop), new Item.Properties());
