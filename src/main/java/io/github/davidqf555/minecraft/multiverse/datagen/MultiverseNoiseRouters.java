...
public final class MultiverseNoiseRouters {
    ...
    public static NoiseRouter noodles(Registry<DensityFunction> density, int minY, int height) {
        NoiseRouter original = NoiseRouterData.floatingIslands(density);
    ...
    public static NoiseRouter blobs(Registry<DensityFunction> density, int minY, int height) {
        NoiseRouter original = NoiseRouterData.floatingIslands(density);
