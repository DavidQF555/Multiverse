...
public final class BiomeNoiseGeneratorSettingsProviderRegistry {
    ...
    public static void onNewRegistry(NewRegistryEvent event) {
        registry = event.create(new RegistryBuilder<BiomeNoiseGeneratorSettingsProvider>().setName(LOCATION.location()).dataPackRegistry(BiomeNoiseGeneratorSettingsProvider.DIRECT_CODEC));
    }
