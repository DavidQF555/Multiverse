...
public final class MultiverseTags {
    ...
    public static final TagKey<EntityType<?>> CONQUEROR_SUMMON = TagKey.create(Registry.ENTITY_TYPE_REGISTRY, new ResourceLocation(Multiverse.MOD_ID, "conqueror_summon"));
