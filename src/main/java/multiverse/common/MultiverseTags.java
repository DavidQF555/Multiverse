...
public final class MultiverseTags {
    ...
    public static final TagKey<Item> KALEIDITE_MATERIALS = TagKey.create(Registries.ITEM, new ResourceLocation(Multiverse.MOD_ID, "kaleidite_materials"));

    public static final TagKey<EntityType<?>> IGNORE_RIFT = TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation(Multiverse.MOD_ID, "ignore_rift"));
