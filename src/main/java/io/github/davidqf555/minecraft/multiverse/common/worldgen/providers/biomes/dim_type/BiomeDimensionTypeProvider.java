...
public interface BiomeDimensionTypeProvider extends BiomeFieldProvider<Holder<DimensionType>> {
    ...
    Codec<BiomeDimensionTypeProvider> DIRECT_CODEC = Codec.lazyInitialized(() -> BiomeDimensionTypeProviderTypeRegistry.getRegistry().byNameCodec().dispatch(BiomeDimensionTypeProvider::getCodec, Function.identity()));
