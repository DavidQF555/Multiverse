...
public final class BiomeNoiseGeneratorSettingsGeneratorRegistry {
    ...
    public static final ResourceKey<Registry<BiomeNoiseGeneratorSettingsGenerator>> LOCATION = ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(Multiverse.MOD_ID, "generator/noise_settings"));
